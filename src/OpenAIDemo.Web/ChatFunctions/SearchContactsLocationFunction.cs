...
public record SearchUsersLocationArguments(
    ...
    [property: Required]
    [property: JsonPropertyName("distance")]
    [property: Description("The distance in kilometers from the coordinate. If the distance is not specified, use 610 km for the distance. If the user specifies miles, convert to kilometers using the `unit_converter` function first.")]
    Measurement Distance,
