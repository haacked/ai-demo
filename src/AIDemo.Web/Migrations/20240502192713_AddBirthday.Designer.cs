...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Haack.AIDemoWeb.Entities.ContactFact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Haack.AIDemoWeb.Entities.Contact", b =>
                {
                    ...
                    b.OwnsOne("Haack.AIDemoWeb.Entities.ContactBirthday", "Birthday", b1 =>
                        {
                            b1.Property<int>("ContactId")
                                .HasColumnType("integer");
            ...
            modelBuilder.Entity("Haack.AIDemoWeb.Entities.ContactFact", b =>
                {
                    b.HasOne("Haack.AIDemoWeb.Entities.Contact", "Contact")
                        .WithMany("Facts")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
