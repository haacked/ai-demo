...
namespace Haack.AIDemoWeb.Migrations
{
    ...
    [Migration("20250504214858_UpdateVectorSize")]
    partial class UpdateVectorSize
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIDemo.Entities.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AIDemo.Entities.ContactFact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ContactId", "Content")
                        .IsUnique();

                    b.ToTable("ContactFacts");
                });
            ...
            modelBuilder.Entity("AIDemo.Entities.Contact", b =>
                {
                    b.OwnsMany("AIDemo.Entities.ContactAddress", "Addresses", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                    ...
                    b.OwnsMany("AIDemo.Entities.ContactEmailAddress", "EmailAddresses", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                    ...
                    b.OwnsMany("AIDemo.Entities.ContactName", "Names", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("AIDemo.Web.Messages.ContactBirthday", "Birthday", b1 =>
                        {
                            b1.Property<int>("ContactId")
                                .HasColumnType("integer");
            ...
            modelBuilder.Entity("AIDemo.Entities.ContactFact", b =>
                {
                    b.HasOne("AIDemo.Entities.Contact", "Contact")
                        .WithMany("Facts")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
